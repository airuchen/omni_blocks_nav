...
def generate_launch_description():
    ...
    launch_dir = os.path.join(get_package_share_directory('omni_blocks_nav'))
    ...
    declare_map_yaml_cmd = launch.actions.DeclareLaunchArgument(
        'map',
        default_value=os.path.join(launch_dir, 'map', 'map.yaml'),
    ...
    declare_params_file_cmd = launch.actions.DeclareLaunchArgument(
        'params',
        default_value=os.path.join(launch_dir, 'param', 'omni.yaml'),
